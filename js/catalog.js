 ...
 *
 * 三種圖層來源：
 *  - wms      ：Landeshauptstadt Dresden 的官方 OGC 服務（kommisdd.dresden.de），以 NodeId 指定資料集。
 *               NodeId 來自 opendata.dresden.de 各資料集頁面的「WMS/WFS」連結；verified=true 代表
 *               在公開索引（GovData、Geoportal Sachsen）中確認過此 NodeId 對應的資料集名稱。
 *  - overpass ：OpenStreetMap，透過 Overpass API 在瀏覽器端即時查詢（跨域允許，最穩定）。
 *  - bundled  ：隨程式附帶的靜態資料（data/stadtteile.js）。
 *
 * 授權：Dresden 官方資料 dl-de/by-2-0（需標示「Landeshauptstadt Dresden, opendata.dresden.de」）；
 *       OSM 資料 ODbL（© OpenStreetMap contributors）。
 */
(function () {
  'use strict';
  ...
  const groups = [
    ...
    { id: 'wohnen', title: '住宅、人口與開發動態', hint: '開發中基地、閒置地與人口指標（可自行匯入 CSV 做 choropleth）。' },
    { id: 'verkehr', title: '交通與運具', hint: '軌道、公車、自行車與共享運具的供給分布。' },
    { id: 'daseins', title: '公共設施與生活機能', hint: '教育、醫療、日常採買與休憩設施：檢視 15 分鐘生活圈的基礎。' },
    { id: 'umwelt', title: '環境、綠地與地形', hint: '保護區、公園、綠量與地形。' },
    { id: 'wasser', title: '水系與洪水風險', hint: '易北河洪氾範圍與河川。Dresden 於 2002、2013 年皆曾遭遇重大洪水。' },
  ];

  // Overpass 查詢用的 Dresden 範圍 (south, west, north, east)
  ...
  const layers = [
    /* ---------- 行政區 ---------- */
    {
      ...
      name: 'Stadtteile 統計分區（61 區）', de: 'Stadtteile',
      desc: '市統計處的 Stadtteil 界線（OSM 轉繪，缺 Langebrück/Schönborn、Cossebaude、Gompitz/Altfranken 三個 Ortschaft）。點擊分區可看面積、所屬 Stadtbezirk 與各圖層設施數。',
    ...
    },
    {
      ...
      name: 'Stadtgrenze 市界', de: 'Stadtgrenze',
      desc: '德勒斯登行政市界（UEK25 基礎）。', source: 'Landeshauptstadt Dresden', license: 'dl-de/by-2-0', color: '#333',
    },

    /* ---------- 土地使用與計畫 ---------- */
    {
      id: 'bplan', group: 'planung', type: 'wms', nodeId: 489, verified: true, default: true,
      name: 'Bebauungspläne 建築計畫範圍', de: 'Bebauungspläne',
      desc: '所有具法律效力與進行中的 B-Plan 範圍，含 qualifizierter/einfacher B-Plan 與程序狀態。點擊地圖可查詢屬性。',
    ...
    },
    {
      ...
      name: 'Bewohnerparkgebiete 住戶停車管理區', de: 'Bewohnerparkgebiete',
    ...
    },
    {
      ...
      desc: '2020 年 10 月 22 日生效的市域土地使用計畫。此資料集的 WMS NodeId 未能在公開索引中確認，請至 opendata.dresden.de 搜尋「Flächennutzungsplan」，將其 WMS 連結中的 NodeId 填入「資料」頁籤的自訂圖層。',
    ...
    /* ---------- 住宅與開發 ---------- */
    {
      ...
      name: '施工中基地 Baustellen', de: 'landuse=construction / building=construction',
      desc: 'OSM 標記為施工中的土地與建物：目前開發熱區的即時側寫。',
    ...
    },
    {
      ...
      name: '閒置／棕地 Brachflächen', de: 'landuse=brownfield|greenfield',
    ...
    },
    {
      ...
      name: '住宅用地 Wohnbauflächen', de: 'landuse=residential',
      desc: 'OSM 住宅用地範圍，用來對照 Stadtteil 的建成密度。資料量較大，載入需數秒。',
    ...
    },
    {
      ...
      desc: '就業用地分布：可對照 Silicon Saxony 北部（Klotzsche）與傳統工業帶。',
    ...
    /* ---------- 交通 ---------- */
    {
      ...
      name: '電車路網 Straßenbahn', de: 'route=tram',
      desc: 'DVB 電車路線：Dresden 大眾運輸骨幹。',
    ...
    },
    {
      ...
      name: '鐵路 Eisenbahn', de: 'railway=rail',
    ...
    },
    {
      ...
      name: '火車站 Bahnhöfe', de: 'railway=station|halt',
      query: 'node["railway"~"^(station|halt)$"]["station"!="subway"]({{bbox}});',
      desc: 'S-Bahn 與長途鐵路車站。', source: 'OpenStreetMap', license: 'ODbL', color: '#2c3e50', radius: 6,
    },
    {
      id: 'osm_mainroads', group: 'verkehr', type: 'overpass', geom: 'line',
      name: '主要道路 Hauptstraßen', de: 'highway=motorway|trunk|primary|secondary',
    ...
    },
    {
      ...
      name: '自行車道 Radwege', de: 'highway=cycleway',
      query: 'way["highway"="cycleway"]({{bbox}});',
      desc: '獨立自行車道（含 Elberadweg）。', source: 'OpenStreetMap', license: 'ODbL', color: '#27ae60', weight: 2,
    },
    {
      id: 'osm_bike_rental', group: 'verkehr', type: 'overpass', geom: 'point',
      name: '共享單車站 Leihräder', de: 'amenity=bicycle_rental',
      query: 'nwr["amenity"="bicycle_rental"]({{bbox}});',
      desc: 'MOBIbike 等共享單車站點。', source: 'OpenStreetMap', license: 'ODbL', color: '#16a085', radius: 4,
    },
    {
      ...
      desc: 'teilAuto 等共享汽車站點。', source: 'OpenStreetMap', license: 'ODbL', color: '#8e44ad', radius: 4,
    },
    {
      id: 'osm_charging', group: 'verkehr', type: 'overpass', geom: 'point',
      name: '充電站 Ladesäulen', de: 'amenity=charging_station',
    ...
    /* ---------- 公共設施 ---------- */
    {
      ...
      name: '學校 Schulen', de: 'amenity=school',
      query: 'nwr["amenity"="school"]({{bbox}});',
      desc: '中小學（Grundschule、Oberschule、Gymnasium 等）。', source: 'OpenStreetMap', license: 'ODbL', color: '#2980b9', radius: 5,
    },
    {
      id: 'osm_kita', group: 'daseins', type: 'overpass', geom: 'point',
      name: '幼兒園 Kitas', de: 'amenity=kindergarten',
      query: 'nwr["amenity"="kindergarten"]({{bbox}});',
      desc: '托育與幼兒園：Dresden 出生率長期為德國大城前段班，Kita 供給是規劃焦點。', source: 'OpenStreetMap', license: 'ODbL', color: '#e84393', radius: 4,
    },
    {
      ...
      desc: 'TU Dresden、HTW 及各研究所（Fraunhofer、Max-Planck、Helmholtz）。', source: 'OpenStreetMap', license: 'ODbL', color: '#34495e', radius: 5,
    },
    {
      id: 'osm_hospital', group: 'daseins', type: 'overpass', geom: 'point',
      name: '醫院 Krankenhäuser', de: 'amenity=hospital|clinic',
    ...
    },
    {
      ...
      name: '超市 Supermärkte', de: 'shop=supermarket',
      query: 'nwr["shop"="supermarket"]({{bbox}});',
      desc: '日常採買：Nahversorgung 的核心指標。', source: 'OpenStreetMap', license: 'ODbL', color: '#27ae60', radius: 4,
    },
    {
    ...
    },
    {
      ...
      name: '遊戲場 Spielplätze', de: 'leisure=playground',
    ...
    /* ---------- 環境與地形 ---------- */
    {
      ...
      name: '公園綠地 Parks', de: 'leisure=park|garden',
      query: 'way["leisure"~"^(park|garden)$"]({{bbox}});',
      relQuery: 'relation["leisure"~"^(park|garden)$"]({{bbox}});',
      desc: '公園與花園（含 Großer Garten）。', source: 'OpenStreetMap', license: 'ODbL', color: '#27ae60', fill: 0.4,
    },
    {
      id: 'osm_allotments', group: 'umwelt', type: 'overpass', geom: 'polygon',
      name: '市民農園 Kleingärten', de: 'landuse=allotments',
      query: 'way["landuse"="allotments"]({{bbox}});',
      relQuery: 'relation["landuse"="allotments"]({{bbox}});',
      desc: 'Dresden 有超過 350 個 Kleingartenverein，是東德城市特色綠地型態。', source: 'OpenStreetMap', license: 'ODbL', color: '#7dcea0', fill: 0.4,
    },
    {
      id: 'osm_forest', group: 'umwelt', type: 'overpass', geom: 'polygon',
      name: '森林 Wald', de: 'landuse=forest / natural=wood',
      query: 'way["landuse"="forest"]({{bbox}});way["natural"="wood"]({{bbox}});',
      relQuery: 'relation["landuse"="forest"]({{bbox}});relation["natural"="wood"]({{bbox}});',
      desc: 'Dresdner Heide 等森林。資料量大，載入需數秒。', source: 'OpenStreetMap', license: 'ODbL', color: '#1e8449', fill: 0.35,
    },
    {
      id: 'gruenes_dresden', group: 'umwelt', type: 'wms', nodeId: 300, verified: true,
      name: 'Grünes Dresden 公園與墓園（官方）', de: 'Parkanlagen, Gärten, Friedhöfe',
    ...
    },
    {
      ...
      name: 'Landschaftsschutzgebiete 景觀保護區', de: 'Landschaftsschutzgebiete',
      desc: '景觀保護區（LSG）：Elbhänge、Dresdner Heide 等，是開發限制的主要範圍。', source: 'Landeshauptstadt Dresden, Umweltamt', license: 'dl-de/by-2-0', color: '#1e8449',
    },
    {
      id: 'gruenvolumen', group: 'umwelt', type: 'wms', nodeId: 1041, verified: true,
      name: 'Grünvolumen 綠量（2009）', de: 'Spezifisches Grünvolumen pro Nettoteilblock 2009',
    ...
    },
    {
      ...
      name: 'DGM1 地形暈渲（彩色）', de: 'Digitales Geländemodell 1 m, Schummerung farbig',
      desc: '1 公尺數值地形模型的彩色暈渲圖：易北河谷地與兩側坡地一目瞭然。', source: 'Landeshauptstadt Dresden, Vermessungsamt', license: 'dl-de/by-2-0', color: '#a04000', opacity: 0.6,
    },
    {
      id: 'dgm', group: 'umwelt', type: 'wms', nodeId: 1459, verified: true,
      name: 'DGM 數值地形模型', de: 'Digitales Geländemodell (DGM)',
    ...
    /* ---------- 水系與洪水 ---------- */
    {
      ...
      name: '易北河 650 cm 潛在淹沒範圍（< HQ5）', de: 'Elbe – 650 cm Pegel Dresden, potentiell überschwemmte Flächen (Modell 2017)',
      desc: '易北河水位 650 cm 時的潛在淹沒面（2017 模型）。2002 年洪峰達 940 cm、2013 年 876 cm，可作為風險對照。',
    ...
    },
    {
      ...
      name: 'Fließgewässer 河川水系', de: 'Fließgewässer',
      desc: '市域內河川與溪流（Weißeritz、Prießnitz、Lockwitzbach 等）。', source: 'Landeshauptstadt Dresden, Umweltamt', license: 'dl-de/by-2-0', color: '#2e86c1',
    },
    {
      id: 'osm_water', group: 'wasser', type: 'overpass', geom: 'polygon',
      name: '水域 Gewässer（OSM）', de: 'natural=water',
  ...
  const presets = [
    ...
    { id: 'daily', title: '生活機能（15 分鐘城市）', desc: '學校、幼兒園、超市、診所藥局、電車站', layers: ['stadtteile', 'osm_schools', 'osm_kita', 'osm_supermarket', 'osm_doctors', 'osm_tram_stops'] },
  ...
  // 市域概況（參考值，請以 Kommunale Statistikstelle 最新出版品為準）
  const facts = [
    { k: '市域面積', v: '328.8 km²', note: '約 1/4 為森林（Dresdner Heide 等），為德國最綠的大城之一。' },
    { k: '人口', v: '約 56 萬', note: '主要居所人口，2023 年底；2000 年代起持續成長，出生率居德國大城前段。' },
    { k: '行政分區', v: '10 Stadtbezirke ＋ 9 Ortschaften', note: '1990 年代併入的周邊鄉鎮保留 Ortschaft 地位與地方議會。' },
    { k: '統計分區', v: '64 Stadtteile', note: '本圖層附帶其中 61 區（OSM 轉繪），再細分為 Statistische Bezirke。' },
    { k: '海拔', v: '101–383 m', note: '易北河谷地約 110 m，兩側為 Elbhänge 坡地與 Dresdner Heide 台地。' },
    { k: '易北河', v: '流經市域約 30 km', note: '2002 年（940 cm）與 2013 年（876 cm）洪水後，洪氾管理為規劃核心議題。' },
    { k: 'Flächennutzungsplan', v: '2020 年 10 月 22 日生效', note: '2020-01-31 版本，取代 1998 年 FNP；下一級為 Bebauungspläne。' },
    { k: '大眾運輸', v: '12 條電車線（DVB）', note: '電車為骨幹，S-Bahn 三條線連結 Meißen、Pirna、機場。' },
    { k: '經濟結構', v: 'Silicon Saxony 半導體聚落', note: 'Klotzsche 北部（Infineon、GlobalFoundries、TSMC/ESMC）帶動住宅與交通需求。' },
    { k: 'Ortschaften 界線缺漏', v: '3 區未含', note: 'Langebrück/Schönborn、Cossebaude/Mobschatz/Oberwartha、Gompitz/Altfranken 需自官方 WFS 補齊。' },
  ];
